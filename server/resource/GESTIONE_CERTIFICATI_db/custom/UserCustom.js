...
app.post(properties.api + '/Users/:id', function (req, res) {
	...
	db_GESTIONE_CERTIFICATI_db.User.findByIdAndUpdate(req.params.id, user, {
		'new': true
	}, function (err, obj) {
...
app['post'](properties.api + '/Users/:id/changePassword', function (req, res) {
	...
	db_GESTIONE_CERTIFICATI_db.User.findOne({
		...
		db_GESTIONE_CERTIFICATI_db.User.findByIdAndUpdate(req.params.id, {
